...
<!--<Cart>-->
	<div x-data="cart(
		...
		<div class="w:100% border:1px|solid|#ddd box-shadow:0|0|10px|#efefef r:5">
			...
			{p:20;rel;bb:1px|solid|fade-88}>div">
				...
				<div>
					<div class="flex jc:space-between ai:center">
						<div class="w:38% aspect:4/3 r:4 background-image:url('https://images.unsplash.com/photo-1493217465235-252dd9c0d632?ixid=MnwzNjUzMTd8MHwxfHNlYXJjaHwyNHx8bGVnb3xlbnwwfHx8fDE2NjM4MzYwNjY&amp;ixlib=rb-1.2.1') bg:cover">
						</div>
						<div class="w:58%">
							<h3 class="m:0 mb:5 f:16 f:18@sm">商品名稱稱商</h3>
							<p class="m:0 f:14@sm f:12">商品規格商品規格的一些說明</p>
							<p class="m:10|0|0|0 f:16 d:block d:none@sm">NT$160</p>
						</div>
					</div>
					<div class="d:none d:block@sm">NT$160</div>
					<div class="mt:10 mt:0@sm float:left">
						...
						{w:32;h:32;f:20;b:1px|solid|fade-80;bg:none;cursor:pointer;r:4;t:center}>div">
							<div type="button" class="bg:fade-90:hover" @click="decreaseQty">-</div>
							<input class="bg:fade-90! f:14 w:40 b:1px|solid|fade-80 h:36 t:center mx:7 r:4 appearance:textfield::-webkit-inner-spin-button" type="number" x-model="qty" />
							<div type="button" class="bg:fade-90:hover" @click="increaseQty">+</div>
						</div>
					</div>
					<div class="float:right f:24 f:red-50 float:none@sm mt:10 mt:0@sm">NT$160</div>
					<div class="clear:both d:block d:none@sm"></div>
					<div class="cursor:pointer p:0! abs top:0 right:5 rel@sm" @click="removeItem">
						<span class="f:red-60">
			...
			<div class="bg:#f0f1f3">
				<div class="p:10 t:right f:14">購物車內合計有 1 項商品</div>
			</div>
		</div>
	</div>
<!--</Cart>-->
